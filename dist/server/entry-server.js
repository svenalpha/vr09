...
import "cors";
const urlx$2 = "http://localhost:5173/testy";
function multiply(a, b) {
  return a * b;
}
async function doFetch() {
  var d = 10;
  console.log("urlx = ", urlx$2);
  const response = await fetch(urlx$2);
  await response.json();
...
const urlx$1 = "https://localhost:5173/api/workoutsx";
function GetEntries() {
  ...
  async function doEntriesy(credentials) {
    ...
    ).then((data) => data.json()).then((data) => setItems(data));
  }
  useEffect(() => {
    doEntriesy();
  }, []);
...
function Home$1() {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("h1", { children: "Home    No73 15:29     23/01/2024  with hydrate solution" }),
    /* @__PURE__ */ jsx("div", { children: addAndMultiply(1, 2, 3) }),
    /* @__PURE__ */ jsx("div", { children: multiplyAndAdd(1, 2, 3) })
  ] });
}
