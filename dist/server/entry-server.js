...
import "mongoose";
import { json, useLoaderData, Link, Routes, Route } from "react-router-dom";
import "cors";
...
function GetEntries() {
  ...
  const doEntries1 = async () => {
    ...
    await axios.get("/api/workout").then((response) => response.json()).then(
      (data) => {
        setItems(data);
      }
    ).then(
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx("h3", { children: "top line, inside return of GetEntries  cc" }),
    items && /* @__PURE__ */ jsxs("h4", { children: [
      "inside return of GetEntries  title =  ",
      items[1].title,
      "  bnnbbb"
    ] }),
    /* @__PURE__ */ jsx("h3", { children: "middle line, inside return of  GetEntries above item list" }),
    /* @__PURE__ */ jsxs("table", { children: [
      /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { children: [
        items && /* @__PURE__ */ jsx("th", { children: "title" }),
        items && /* @__PURE__ */ jsx("th", { children: "reps" })
      ] }) }),
      /* @__PURE__ */ jsx("tbody", { children: items && items.map((item) => {
        return /* @__PURE__ */ jsxs("tr", { children: [
          /* @__PURE__ */ jsx("td", { children: item.title }),
          /* @__PURE__ */ jsx("td", { children: item.reps })
        ] }, item._id);
      }) })
    ] }),
    /* @__PURE__ */ jsx("h3", { children: "bottom line, inside return of GetEntries below items list " })
  ] }) });
}
function About() {
  ...
  const doLoad = async () => {
    ...
    await axios.get("/api/workout/").then(
      (res4) => {
        console.log("in About.jsx, in doLoad, /test1 res4.data = ", res4.data);
      }
    ).catch(
      (err4) => {
        console.log("catch err4 of test1= ", err4);
      }
    );
...
const url = "./src/routes/workoutRoutes/test99";
...
function Home$1() {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("h1", { children: "Home    No94 14:35 15/02/2024 with hydrate solution" }),
    /* @__PURE__ */ jsx("div", { children: addAndMultiply(1, 2, 3) }),
    /* @__PURE__ */ jsx("div", { children: multiplyAndAdd(1, 2, 3) })
  ] });
}
...
routes.push(
  {
    ...
    element: /* @__PURE__ */ jsx("workoutRoutes", {})
  }
);
...
routes.push(
  {
    ...
    loader() {
      return json({ message: "inside React Router  " });
    },
    component() {
      useLoaderData();
